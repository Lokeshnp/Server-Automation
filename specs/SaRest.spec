...
//* And execute sa rest get api by adding the plan id in path parameters
//* Verify API is returning HTTP 200 status code & Plan definition XML template
//* And add target computer name in target-set tag of plan definition XML
...
//-----------------------------------------------------------------
//*tags:
//* When User sends SA-REST Plan Action Api Request for the existing plan action id
//* Then in response user should get http 200 status code
//* And response body as plan status xml template
//* And user should validate the plan status xml template
//
...
//-----------------------------------------------------------------------
//*tags:
//* When User sends SA-REST Plan Action Api Request with invalid authentication parameters
//* Then in response user should get http 401 status code
//* And user should validate the error message in response body
//
