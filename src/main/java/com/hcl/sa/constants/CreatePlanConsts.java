...
public enum CreatePlanConsts {
    ...
    EXECUTE_PLAN("executePlan"), PLAN_WITH_COMBINATION_OF_FIXLETS_TASKS_BASELINE("Plan with combination of fixlets_tasks_baseline"),PLAN_ACTION_ID("planActionID"), FIXLET_DETAILS("fixletDetails"),
