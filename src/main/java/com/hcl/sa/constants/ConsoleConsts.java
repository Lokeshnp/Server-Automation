...
public enum ConsoleConsts {
    ...
    CONSOLE_API("consoleApi"), RELEVANT_COMPUTERS("relevantComputers"), OPERATOR("operator"), SAOPERATOR1("SAOperator1"),
    ...
    TAKE_ACTION_PAYLOAD_PATH(System.getenv("take_action_payload_path")), MASTER_ACTION_SITE("Master Action Site"), CREATE_OPERATOR("createOperator"),ASSIGN_SITE("assignSite"),
    FIXLET("Fixlet"), ROOT_SERVER(System.getenv("bigfix_server_name")), TASK("Task"), PLAN_ACTION("executePlanAction"), DELETE_OPERATOR("delete_operator"),
    ...
    ASSIGN_SA_SITE_PAYLOAD_PATH(System.getenv("sa_site_permission_payload_path")), ASSIGN_CUSTOM_SITE_PAYLOAD_PATH(System.getenv("custom_site_permission_payload_path")), OPERATOR_VALUE("SAOperator1");
