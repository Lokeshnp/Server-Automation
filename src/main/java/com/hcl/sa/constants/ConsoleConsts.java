...
public enum ConsoleConsts {
    ...
    CREATE_BASELINE_PAYLOAD_PATH(System.getenv("create_baseline_payload_path")), SA("SA"), HTTP_SC_OK("200"),HTTP_SC_UNAUTH("401"),
    FIXLET_LIST("fixletList"), ACTION("Action"), DELETE_PLAN("deletePlan"), CREATE_TASKS("createTasks"),
    ...
    TAKE_ACTION_PAYLOAD_PATH(System.getenv("take_action_payload_path")), MASTER_ACTION_SITE("Master Action Site"), SRC_SITENAME("CustomSite_Pooja"),
