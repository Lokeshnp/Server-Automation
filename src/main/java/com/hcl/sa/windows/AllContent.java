...
public class AllContent  {
    ...
    public int getServerAutomationSiteNameIndex(){
        int saIndex = 0;
        List<WebElement> externalSitesList = winActions.findElementsByXpath(AllContentsLocators.external_sties_xpath);
        logger.debug("External Sit List size="+externalSitesList.size());
